...
- 2026-05-09 edge cleanup: by operator request, `directbuy.aidevteam.ru` was removed from `central-caddy` on `80.74.28.160`; Caddy validate/reload passed and live `/etc/caddy/Caddyfile` no longer contains the Direct Buy route. No changes were made on `91.132.59.194`; direct DNS/TLS setup on the app host is operator-owned.
