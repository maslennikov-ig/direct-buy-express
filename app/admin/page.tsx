...
const kpis = [
  ...
  { title: "Сделок за неделю", value: "34", icon: CheckCircle2, color: "text-emerald-500" },
  { title: "Ждут проверки (Инвесторы)", value: "5", icon: Users, color: "text-amber-500" },
];

const slaAlerts = [
  { id: "LOT-1042", address: "г. Москва, ул. Тверская, д. 15", status: "Ожидает аванс", delay: "2ч 15м", investor: "@investor_pro" },
  { id: "LOT-1038", address: "г. Санкт-Петербург, Невский пр., д. 45", status: "Клиент молчит", delay: "4ч 30м", investor: "-" },
  { id: "LOT-1045", address: "г. Казань, ул. Баумана, д. 10", status: "Ожидает аванс", delay: "2ч 05м", investor: "@kazan_invest" },
];
    ...
    <div className="space-y-8">
      ...
      <Card className="bg-black border-white/10">
        <CardHeader>
          ...
          <p className="text-sm text-white/50">Сделки, зависшие более чем на 2 часа.</p>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
              <TableRow className="border-white/10 hover:bg-white/5">
                ...
                <TableHead className="text-white/50">Инвестор</TableHead>
            ...
            <TableBody>
              {slaAlerts.map((alert) => (
                <TableRow key={alert.id} className="border-white/10 hover:bg-white/5">
                  ...
                  <TableCell className="text-white/70">{alert.investor}</TableCell>
